...
import type { CreateMemeRequest as _CreateMemeRequest, ExternalBlob as _ExternalBlob, Meme as _Meme, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createMeme(arg0: CreateMemeRequest): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.createMeme(await to_candid_CreateMemeRequest_n10(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteMeme(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getMemeById(arg0: bigint): Promise<Meme | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getMemeById(arg0);
    ...
    async getMemeCount(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getMemeCount();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getMemesByUser(arg0: Principal): Promise<Array<Meme>> {
        if (this.processError) {
            try {
    ...
    async getMostLikedMemes(arg0: bigint): Promise<Array<Meme>> {
        if (this.processError) {
            try {
                const result = await this.actor.getMostLikedMemes(arg0);
                return from_candid_vec_n20(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTotalLikes(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getTotalLikes();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTrendingTags(arg0: bigint): Promise<Array<string>> {
        if (this.processError) {
            try {
    ...
    async getUserMemeCount(arg0: Principal): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getUserMemeCount(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getUserTotalLikes(arg0: Principal): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getUserTotalLikes(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async hasLikedMeme(arg0: bigint): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.hasLikedMeme(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async toggleLikeMeme(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.toggleLikeMeme(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_Meme_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Meme): Promise<Meme> {
...
async function from_candid_opt_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Meme]): Promise<Meme | null> {
    return value.length === 0 ? null : await from_candid_Meme_n17(_uploadFile, _downloadFile, value[0]);
}
...
async function from_candid_vec_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Meme>): Promise<Array<Meme>> {
    return await Promise.all(value.map(async (x)=>await from_candid_Meme_n17(_uploadFile, _downloadFile, x)));
}
async function to_candid_CreateMemeRequest_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: CreateMemeRequest): Promise<_CreateMemeRequest> {
